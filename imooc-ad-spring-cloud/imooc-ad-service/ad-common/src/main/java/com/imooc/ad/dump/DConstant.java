...
public class DConstant {
    ...
    public static final String DATA_ROOT_DIR = "/Users/wangshaocheng/IdeaProjects/imooc-ad/imooc-ad-spring-cloud/mysql_data/";
    ...
    public static final String AD_UNIT_DISTIRCT = "ad_unit_district.data";
